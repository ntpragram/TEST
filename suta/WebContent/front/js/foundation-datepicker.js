...
! function($) {
    ...
    var Datepicker = function(element, options) {
        ...
        if (this.isRTL) {
            ...
            this.picker.find('.dateprev i, .datenext i')
                ...
                switch (target[0].nodeName.toLowerCase()) {
                    case 'th':
                        switch (target[0].className) {
                            ...
                            case 'dateprev':
                            case 'datenext':
                                var dir = DPGlobal.modes[this.viewMode].navStep * (target[0].className == 'dateprev' ? -1 : 1);
                                switch (this.viewMode) {
                                    case 0:
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>' +
            '<tr>' +
            '<th class="dateprev"><i class="fa fa-chevron-left fi-arrow-left"/></th>' +
            '<th colspan="5" class="date-switch"></th>' +
            '<th class="datenext"><i class="fa fa-chevron-right fi-arrow-right"></i></th>' +
            '</tr>' +
            '</thead>',

						...
						<div class="layui-form" action="">
							<input type="hidden" name="id" id="id" value="${id}" title=" ">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="num" name="type" 
											value="${type}" placeholder="0"  readonly="readonly" lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>
								...
								<div class="layui-form-item">
									<label class="layui-form-label">手机端图片</label>
									<div class="layui-input-block">
										<img alt="暂无图片" src="<%=basePath%>${mtpic}" id="pic_appBig" style="width: 20%;">
									</div>
								</div>	
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									jq.post(sysUrl+'picture/modifyPicture',json,function(data){

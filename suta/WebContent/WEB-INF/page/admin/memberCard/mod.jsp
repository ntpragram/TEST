						...
						<div class="layui-form" action="">
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="phone" id="phone" 
											value="${phone}" placeholder="请输入手机号"  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>							
							...
							<div class="layui-form-item" >
								...
								<select id="cardId" name="cardId">
									...
									<option value="${v.id}" <c:if test="${cid==v.id }">selected</c:if>>${v.title}</option>
									</c:forEach>
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									jq.post(sysUrl+'memberCard/modifySubmit',json,function(data){

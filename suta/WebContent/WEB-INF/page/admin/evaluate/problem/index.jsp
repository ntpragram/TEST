...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">测评问题管理</li>
	...
	<div class="layui-tab-content">
      ...
      <form class="layui-form layui-form-pane search-form">
        ...
        <div class="layui-btn-group">
          ...
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd(${resultData.eid})">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
               <input type="hidden" id="eid" name="eid" value="${resultData.eid}" >
                <input type="hidden" id="modelName"  value="evaluateProblem" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
                                ...
                                <td style="text-align: center;"><a href="javascript:;" class="layui-btn layui-btn-warm layui-btn-small" title="答案列表" onclick="problemAnswerList(${v.id},${resultData.eid})">答案列表</a></td>
...
<script type="text/javascript">
    ...
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&eid='+eid;
...
function toAdd(eid){
   ...
   layer.open({
      ...
      area: ['70%','70%'],
      title: '添加',
      content: sysUrl+'evaluate/toAddProblem?eid='+eid
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['60%','60%'],
      title: '修改',
      content: sysUrl+'evaluate/toModifyProblem?id='+id 
    });

...
<div class="layui-tab layui-tab-brief main-tab-container" >
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">图片管理</li>
	...
	<div class="layui-tab-content">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="picture" >
                <input type="hidden" id="type" name="type" value="${resultData.type}" >
...
<script type="text/javascript">
    ...
    var search = "${resultData.type}";
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&type='+type;
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'picture/toModify?id='+id 
    });

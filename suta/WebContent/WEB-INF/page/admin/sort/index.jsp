...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">类别管理</li>
	...
	<div class="layui-tab-content">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="sort" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
                                ...
                                <a href="javascript:;" class="layui-btn layui-btn-warm layui-btn-small" title="二级类别" onclick="LevelTwoList(${v.id})">二级类别</a></td>
...
<script type="text/javascript">
    ...
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&level='+level;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&level='+level;
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['60%','60%'],
      title: '修改',
      content: sysUrl+'sort/toModify?id='+id 
    });
}

function LevelTwoList(panId){
    var layer = layui.layer;
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'sort/getSortTwoList?panId='+panId
    });

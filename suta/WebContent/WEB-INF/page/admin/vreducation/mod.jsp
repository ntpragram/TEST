					...
					<div class="ibox-content layui-form">
						<div class="layui-form" action="">
							<input type="hidden" name="id" id="id" value="${id}" title=" ">
								...
								<div class="layui-form-item">
									<label class="layui-form-label">手机端图</label>
									<div class="layui-input-block">
										<a href="javascript:$('#typeMTPicApp').click();" class="layui-btn layui-btn-primary">上传图片</a>
									</div>
								</div>
								...
								<div class="layui-form-item">
									<label class="layui-form-label">手机端图</label>
									<div class="layui-input-block">
										<img alt="暂无图片" src="<%=basePath%>${mtpic}" id="mtpic_app" style="width: 20%;">
									</div>
								</div>
						...
						<div style="display: none;">
							...
							<input type="file" id="typeMTPicApp" accept="image/jpg,image/png,image/jpeg" name="mtpic_app" >
						</div>
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								layui.upload({
									  ...
									  ext: 'jpg|png|jpeg',
									  success: function(res){
									  	$('#mtpic_app').attr("src",'<%=basePath%>'+res.data.img);
									  	//$('#mtpic_app').attr("pic_src",res.data.img);
								...
								form.on('submit(form)', function(data) {
									...
									var content = $("#content").val();
										...
										if(picSmall==""){
											layer.msg("请添加标题图片", {icon: 2,anim: 6, time: 1000});
											return;
										}
										if(picBig==""){
											layer.msg("请添加详情图", {icon: 2,anim: 6, time: 1000});
											return;
										}
										if(content==""){
									...
									data.field.mtpic = $('#mtpic_app').attr("src");
									var json = {where:JSON.stringify(data.field),modelName:'${modelName}'};
									jq.post(sysUrl+'level/modifyVREducation',json,function(data){

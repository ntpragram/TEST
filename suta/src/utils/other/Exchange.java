...
public class Exchange {
	...
	private static List<String[]> arrayLists;
	...
	public static void main(String[] args) {
		...
		list.add(size);
		list.add(version);
		list = new Exchange().arrange(list);
		System.out.println(list.get(0).getClass().getName());
	}

	public List arrange(List arrayLists){
		new Exchange().doExchange(arrayLists);
		List list = this.arrayLists;
		return list;
	}

						...
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							...
							<%-- 	<td class="first" style="text-align: center;">
                                ...
                                <td style="text-align: center;">${v.zanNum}</td>                            
                                 <td style="text-align: center;"><a href="javascript:;" class="layui-btn layui-btn-warm layui-btn-small" title="回复答案列表" onclick="answerList(${v.replier},${v.fid})">回答列表</a></td>
							</tr>
						</c:forEach>
...
<script type="text/javascript">
    ...
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&fid='+fid;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&fid='+fid;
...
function answerList(repUid,fid){
    var layer = layui.layer;
     layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'forum/getByAnswerForumList?fid='+fid+'&repUid='+repUid
    });

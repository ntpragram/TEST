							...
							<input type="hidden" id="businesstype" name="businesstype"  value="${businesstype}" >							
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" id="title" 
											value="${record.title}" placeholder="请输入套餐名称"  lay-verify="" autocomplete="off"
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
            						  ...
            						  <option value="${record.id}" checked>${record.tprice}</option>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										value="${record.service}" placeholder="请输入套餐价格" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
									<a href="<%=basePath%>businessmenadmin/menu/getChooseMenuList?pid=${record.pid}"  class="layui-btn layui-btn-small" title="菜单选择">菜单选择</a>	
									</div>
								</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="service" id="service" 
											value="${record.service}" placeholder="请输入服务费" required  lay-verify="" autocomplete="off"
								...
								<div class="layui-form-item" >
									...
									<div class="layui-input-block">
										<input type="text" name="corkage" id="corkage"
											value="${record.corkage}" placeholder="请输入开瓶费" required  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>	
								<div class="layui-form-item" >
									...
									<div class="layui-input-block">
										<input type="text" name="entry" id="entry"
											value="${record.entry}" placeholder="请输入入场费" required  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>
								</c:if>
						...
						<script type="text/javascript">						
							...
							var element = layui.element()
								...
								form.on('submit(form)', function(data) {
                					...
                					jq.post('businessmenadmin/menu/modifyTaoCan',json,function(data){

...
//ajax删除
        ...
        jq('.del_btn').click(function(){
            ...
            layer.confirm('确定删除?', function(index){
                ...
                jq.post(sysUrl+'product/deletePic',{'ids':id,model:modelName},function(data){
                    layer.close(loading);    
                    if(data.success){
...
//判断是否有选项
            ...
            layer.confirm('确定批量删除吗?', function(index){
                ...
                jq.post(sysUrl+'product/deletePic',param,function(data){
                    layer.close(loading);
                    if(data.code==200){
                        layer.msg(data.message, {icon: 1, time: 1000}, function(){
...
function toAdd(pid){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'product/toAddPic?pid='+pid
    });

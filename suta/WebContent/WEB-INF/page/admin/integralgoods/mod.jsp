								 ...
								 <div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="number" name="integral"  id="integral"
											value="${integral}" placeholder="<c:if test="${tag==0}">请输入云币</c:if><c:if test="${tag==1}">请输入杉币</c:if>"  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div> 
								 ...
								 <div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="number" name="price"  id="price"
											value="${price}" placeholder="请输入金额"  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div> 
								</c:if>
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									jq.post(sysUrl+'integralProduct/modifySubmit',json,function(data){

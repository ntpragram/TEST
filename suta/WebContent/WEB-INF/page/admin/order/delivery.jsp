						...
						<div class="layui-form" action="">
							...
							<input type="hidden" name="id" id="id" value="${id}" title=" ">	
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" 
											value="${shouhuoren}" placeholder="请输入标题" required readonly lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" 
											value="${phone}" placeholder="请输入标题" required readonly lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" 
											value="${addressDetail}" placeholder="请输入标题" required readonly lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>
								
								<c:forEach items="${orderSonList}" var="v" varStatus="i">
								<div class="layui-form-item" style="margin-top: 30px">
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<select id="courier" name="courier">
										...
										<option value="${v.introduce}" <c:if test="${v.introduce==courierCompany }">selected</c:if>   >${v.title}</option>
										</c:forEach>
									</select>
									</div>
								</div>	
								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="courierNumber"  id="courierNumber"
											value="${CourierNumber}" placeholder="请输入单号" required  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>		

								...
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="content" id="content" 
											value="${record.content}" placeholder="请输入问候语"  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>																
...
<!--
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<textarea id="content" name="content" id="content" lay-verify="layedit" autocomplete="off" placeholder="请输入内容" class="layui-textarea layui-hide">${record.content}</textarea>
									</div>
								</div>
-->
								<div class="layui-form-item">
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									jq.post(sysUrl+'about/modifyAbout',json,function(data){

				...
				<div class="ibox float-e-margins">
					<div class="ibox-content layui-form">
						<div class="layui-form" action="">
							<input type="hidden" name="uid" id="uid" value="${uid}" title=" ">
							<input type="hidden" name="id" id="id" value="${id}" title=" ">	
								<div class="layui-form-item" style="margin-top: 30px">
									<label class="layui-form-label">内容</label>
									<div class="layui-input-block">
										<input type="text" 
											value="${content}" placeholder="" readonly required  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>	
									...
									<input type="text"  id="content" name="content"
											value="" placeholder="请输入内容"  required  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>

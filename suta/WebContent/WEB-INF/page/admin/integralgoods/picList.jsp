...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">产品图片管理</li>
	...
	<div class="layui-tab-content">
       ...
       <form class="layui-form layui-form-pane search-form">
        ...
        <div class="layui-btn-group">
          ...
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd(${resultData.pid})">
...
<script type="text/javascript">
    ...
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&pid='+pid;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&pid='+pid;
...
//ajax删除
        ...
        jq('.del_btn').click(function(){
            ...
            layer.confirm('确定删除?', function(index){
                ...
                jq.post(sysUrl+'integralProduct/deletePic',{'ids':id,model:modelName},function(data){
                    layer.close(loading);    
                    if(data.success){
...
//判断是否有选项
            ...
            layer.confirm('确定批量删除吗?', function(index){
                ...
                jq.post(sysUrl+'integralProduct/deletePic',param,function(data){
                    layer.close(loading);
                    if(data.code==200){
                        layer.msg(data.message, {icon: 1, time: 1000}, function(){
...
function toAdd(pid){ 	
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'integralProduct/toAddPic?pid='+pid
    });

	...
	<div class="layui-tab-content">
		<div class="layui-tab-item layui-show">
			...
			<form class="layui-form layui-form-pane search-form">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
						...
						<input type="text" id="search" value="${resultData.search}" lay-verify="" placeholder="搜索订单号" autocomplete="off" class="layui-input">
						</div>
			...
			<form class="layui-form">
				<input type="hidden" id="brokerStatus"  value="${resultData.brokerStatus}" title=" ">
				...
				<table class="list-table">
					<thead>
						...
						<th style="text-align: center;">抵扣价格</th>
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td style="text-align: center;">${v.allPrice}</td>
								<td style="text-align: center;">${v.sfPrice}</td>
								<td style="text-align: center;">${v.redPacketPrice}</td>
								<td style="text-align: center;">
								<c:choose>
								<c:when test="${v.brokerStatus==0}">待审核</c:when>
								<c:when test="${v.brokerStatus==1}">审核通过</c:when>
								<c:when test="${v.brokerStatus==2}">审核未通过</c:when>
								</c:choose>
								</td>
								<td style="text-align: center;">${v.realName}</td>
								<td style="text-align: center;">${v.createTime}</td>
								 <td style="text-align: center;"><a href="javascript:;" class="layui-btn layui-btn-small" title="查看产品" onclick="toDetail(${v.id})">查看产品</a></td>
								<c:if test="${v.brokerStatus==0}">
...
<script type="text/javascript">
	...
	var brokerStatus = "${resultData.brokerStatus}";
	...
	var urlWhere = '?offset='+pageNumber+'&limit='+page_size+'&brokerStatus='+brokerStatus+'&paystyle='+paystyle+'&platform='+platform+'&search='+search+'&startTime='+startTime+'&endTime='+endTime;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&ostatus='+ostatus+'&paystyle='+paystyle+'&platform='+platform+'&search='+search+'&startTime='+startTime+'&endTime='+endTime+'&brokerStatus='+brokerStatus;
	}

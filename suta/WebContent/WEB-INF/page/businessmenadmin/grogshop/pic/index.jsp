        ...
        <div class="layui-btn-group" >
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd()">
			...
			<form class="layui-form">
				...
				<input type="hidden" id="pid" value="${resultData.pid}" title=" ">
				<input type="hidden" id="gsid" value="${resultData.gsid}" title=" ">
                <input type="hidden" id="modelName"  value="pic" >
...
<script type="text/javascript">
	...
	var urlWhere = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&type='+type+'&pid='+pid;
			
	function pageJump(pageNumber){
		type = $("#type").val();
		search = $("#search").val();
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&type='+type+'&pid='+pid;
	}
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['100%','100%'],
      title: '添加',
      content: 'toAdd?type='+type+"&pid="+pid+"&gsid="+gsid
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['100%','100%'],
      title: '修改',
      content: sysMerchantUrl+'pic/toModify?id='+id 
    });

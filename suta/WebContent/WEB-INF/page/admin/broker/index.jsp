...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">经纪人列表</li>
		<div class="main-tab-item" style="left: 10px;top:0px;">经纪人管理</div>
	</ul>
         ...
         <form class="layui-form layui-form-pane search-form">
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-inline">
                      <input type="text" name="search" id="search" value="${resultData.title}" lay-verify="" placeholder="请输入姓名搜索" autocomplete="off" class="layui-input">
                  </div>
        ...
        <div class="layui-btn-group">
          ...
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd()">
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="broker" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td style="text-align: center;">${v.workNumber}</td>
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'broker/toModify?id='+id 
    });

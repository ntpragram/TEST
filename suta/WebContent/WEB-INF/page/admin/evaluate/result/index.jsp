...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">测评结果管理</li>
      ...
      <form class="layui-form layui-form-pane search-form">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">         
                <input type="hidden" id="modelName"  value="evaluateResult" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td style="text-align: center;">${v.answers}</td> 
...
function toAdd(eid){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '添加',
      content: sysUrl+'evaluate/toAddResult'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '修改',
      content: sysUrl+'evaluate/toModifyResult?id='+id 
    });

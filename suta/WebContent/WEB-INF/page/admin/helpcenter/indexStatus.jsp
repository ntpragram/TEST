...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">帮助中心类别列表</li>
		<div class="main-tab-item" style="left: 10px;top:0px;">类别管理</div>
	</ul>
        ...
        <div class="layui-btn-group">
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd()">
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="helpCenterStatus" >
						...
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td class="table2-edit" style="text-align: center;">
                                    ...
                                    <a href="javascript:;" onclick="modifyPx(${v.id},${v.px})" gsid="${v.id}" o_px="${v.px}" class="layui-btn layui-btn-mini">确定</a>
                                </td>
...
<script type="text/javascript">
	...
	function pageJump(pageNumber){
		search = $("#search").val();
		window.location.href = 'getHelpCenterStatusList?offset='+pageNumber+'&limit='+page_size+'&search='+search;
	}
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '添加',
      content: sysUrl+'helpCenter/toAddStatus'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '修改',
      content: sysUrl+'helpCenter/toModifyStatus?id='+id 
    });

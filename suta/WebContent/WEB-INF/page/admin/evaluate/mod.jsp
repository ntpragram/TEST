							...
							<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="remark" 
											value="${content}" placeholder="请输入简介"  lay-verify="" autocomplete="off"
											class="layui-input">
									</div>
								</div>
								<div class="layui-form-item">
								...
								<div class="layui-form-item">
									<label class="layui-form-label">小图</label>
									<div class="layui-input-block">
										<img alt="暂无图片" src="<%=basePaths%>${smallPic}" id="pic_app" style="width: 20%;">
									</div>
								</div>
						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									jq.post(sysUrl+'evaluate/modifySubmit',json,function(data){

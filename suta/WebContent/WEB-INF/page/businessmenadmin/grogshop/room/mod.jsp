				...
				<div class="ibox float-e-margins">
					<div class="ibox-content layui-form">
						<div class="layui-form" action="">
							<input type="hidden" name="rid" id="rid" value="${record.rid}" title="">							
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="desk" id="desk" 
											value="${record.desk}" placeholder="请输入桌数"  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										value="${record.price}" placeholder="请输入餐厅最低消费" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										value="${record.endprice}" placeholder="请输入餐厅最高消费" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
										<!-- onkeyup="value=value.replace(/^[0-9]*[1-9][0-9]*$/g,'')" -->
									</div>
								</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="area" id="area" 
											value="${record.area}" placeholder="请输入餐厅面积" required  lay-verify="" autocomplete="off"
								...
								<div class="layui-form-item" >
									...
									<div class="layui-input-block">
										<input type="text" name="hige" id="hige"
											value="${record.hige}" placeholder="请输入餐厅高度" required  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>	
								<div class="layui-form-item" >
									...
									<div class="layui-input-block">
										<input type="text" name="pillar" id="pillar"
											value="${record.pillar}" placeholder="请输入餐厅的柱子" required  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>	
								<div class="layui-form-item" >
									...
									<div class="layui-input-block">
										<input type="text" name="shape" id="shape"
											value="${record.shape}" placeholder="请输入餐厅的形状" required  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>
								</c:if>
          						<c:if test="${businesstype==2}">
									<div class="layui-form-item">
									<label class="layui-form-label">餐厅原价(单位/元)</label>
									<div class="layui-input-block">
										<input type="text" name="oprice" id="oprice" 
										value="${record.oprice}" placeholder="请输入原价" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
										<!-- onkeyup="value=value.replace(/^[0-9]*[1-9][0-9]*$/g,'')" -->
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label">餐厅现价(单位/元)</label>
									<div class="layui-input-block">
										<input type="text" name="cprice" id="cprice" 
										value="${record.cprice}" placeholder="请输入现价" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
										<!-- onkeyup="value=value.replace(/^[0-9]*[1-9][0-9]*$/g,'')" -->
									</div>
								</div>
						...
						<script type="text/javascript">						
							...
							var element = layui.element()
								...
								form.on('submit(form)', function(data) {
                					...
                					jq.post('businessmenadmin/room/modifyHall',json,function(data){

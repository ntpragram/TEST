						...
						<script type="text/javascript">
							...
							layui.use(['element','form','upload','layedit'], function() {
								...
								form.on('submit(form)', function(data) {
									...
									var ThreePic =$('#pic_appThree').attr("src");

									if(pic==""){
										layer.msg("请添加图片1", {icon: 2,anim: 6, time: 1000});
										return;
									}
									if(bigPic==""){
										layer.msg("请添加图片2", {icon: 2,anim: 6, time: 1000});
										return;
									}
									if(ThreePic==""){
										layer.msg("请添加图片3", {icon: 2,anim: 6, time: 1000});
										return;
									} */
									...
									jq.post(sysUrl+'integralProduct/addPicSubmit',json,function(data){

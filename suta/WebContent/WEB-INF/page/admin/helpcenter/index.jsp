...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">帮助中心列表</li>
		<div class="main-tab-item" style="left: 10px;top:0px;">帮助中心管理</div>
	</ul>
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td style="text-align: center;">${v.parentTitle}</td>
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'helpCenter/toAdd'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'helpCenter/toModify?id='+id 
    });

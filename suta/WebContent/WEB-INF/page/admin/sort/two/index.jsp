...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">${resultData.sortTitle}二级类</li>
		<div class="main-tab-item" style="left: 10px;top:0px;">
        	${resultData.sortTitle}
        </div>
	</ul>
	<div class="layui-tab-content">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="sortTwo" >
...
<script type="text/javascript">
    ...
    var panId= "${resultData.panId}";
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&panId='+panId;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&panId='+panId;
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'sort/toAddTwoLevel?panId='+panId
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'sort/toSortTwoModify?id='+id+'&panId='+panId 
    });
}

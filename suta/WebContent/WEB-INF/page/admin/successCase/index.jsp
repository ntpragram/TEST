...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">VR教育</li>
	...
	<div class="layui-tab-content">
            ...
            <form class="layui-form layui-form-pane search-form">
			 ...
			 <form id="uploadFile" enctype="multipart/form-data">
		        ...
		        <span>成功案例主键：</span>
		        <input  name="levelid" value="" placeholder="请输入主键ID"/>
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="vREducation" >
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'level/toSuccessCaseAdd'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'level/toModifySuccessCase?id='+id 
    });

...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">会员卡包</li>
	...
	<div class="layui-tab-content">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="memberCard" >
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '添加',
      content: sysUrl+'memberCard/toAdd'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['70%','70%'],
      title: '修改',
      content: sysUrl+'memberCard/toModify?id='+id 
    });

...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">规格管理</li>
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
                                ...
                                <a href="javascript:;" class="layui-btn layui-btn-normal layui-btn-small" title="类别管理" onclick="sort(${v.id})">类别列表</a></td>
...
function toAdd(pid){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'product/toAddStandard?pid='+pid
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'product/toModifyStandard?id='+id 
    });
}
...
function sort(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '规格列表',
      content: sysUrl+'product/getStandardSortList?sid='+id 
    });
}

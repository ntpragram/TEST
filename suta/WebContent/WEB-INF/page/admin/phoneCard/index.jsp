...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">卡包管理</li>
	...
	<div class="layui-tab-content">
           ...
           <%--  <form class="layui-form layui-form-pane search-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="search" id="search" value="${resultData.search}" lay-verify="" placeholder="请输入手机号搜索" autocomplete="off" class="layui-input">
                    </div>
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="phoneCard" >
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'phoneCard/toAdd'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'phoneCard/toModify?id='+id 
    });

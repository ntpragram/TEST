...
public class SmartUpload
{
  ...
  public void upload(String charSet) throws ServletException, IOException, SmartUploadException
  {
    ...
    for (this.m_currentIndex += 1; this.m_currentIndex < this.m_totalBytes; this.m_currentIndex += 2) {
      ...
      if (flag3) {
        ...
        String s11 = "";
        if (charSet == null)
          s11 = new String(this.m_binArray, this.m_startData, 
            this.m_endData - this.m_startData + 1);
        else {
          s11 = new String(this.m_binArray, this.m_startData, 
            this.m_endData - this.m_startData + 1, Charset.forName(charSet));
        }
  ...
  public int save(String s, int i) throws ServletException, IOException, SmartUploadException
  {
    ...
    for (int k = 0; k < this.m_files.getCount(); k++) {
      ...
      this.m_files.getFile(k).saveAs(s + this.m_files.getFile(k).getFileName(), 
        i);
  ...
  public void downloadFile(String s, String s1, String s2, int i) throws ServletException, IOException, SmartUploadException
  {
    ...
    if (s2 == null) {
      ...
      this.m_response.setHeader("Content-Disposition", 
        this.m_contentDisposition + " filename=" + toUtfString(s2));
    }

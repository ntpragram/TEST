...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">测评问题答案管理</li>
	...
	<div class="layui-tab-content">
      ...
      <form class="layui-form layui-form-pane search-form">
        ...
        <div class="layui-btn-group">
          ...
          <span class="layui-btn layui-btn-small modal-catch" onclick="toAdd(${resultData.eid},${resultData.pid})">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
               <input type="hidden" id="eid" name="eid" value="${resultData.eid} }" >
                <input type="hidden" id="pid" name="pid" value="${resultData.pid} }" >
                <input type="hidden" id="modelName"  value="evaluateProblemAnswer" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
								...
								<td style="text-align: center;">${v.titleChar}</td>
								<td style="text-align: center;">${v.answer}</td> 
...
<script type="text/javascript">
    ...
    var eid = "${resultData.eid}";
    var pid = "${resultData.pid}";
    var urlWhere ='?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&eid='+eid+'&pid='+pid;
	...
	function pageJump(pageNumber){
		...
		window.location.href = '?offset='+pageNumber+'&limit='+page_size+'&search='+search+'&eid='+eid;
...
function toAdd(eid,pid){
    ...
    layer.open({
      ...
      area: ['60%','60%'],
      title: '添加',
      content: sysUrl+'evaluate/toAddProblemAnswer?eid='+eid+'&pid='+pid
    });
}
function toMod(id){
    var layer = layui.layer;
    layer.open({
      ...
      area: ['60%','60%'],
      title: '修改',
      content: sysUrl+'evaluate/toModifyProblemAnswer?id='+id 
    });
}

function problemAnswerList(pid,eid){
    var layer = layui.layer;
	  layer.open({
	      type: 2,
	      icon: 2,
	      ...
	      area: ['90%','90%'],
	      title: '答案列表',
	      content: sysUrl+'evaluate/problemAnswerList?eid='+eid+'&pid='+pid
	    });

...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">测评管理</li>
	...
	<div class="layui-tab-content">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">
                ...
                <input type="hidden" id="modelName"  value="evaluate" >
						...
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
                                ...
                                <td style="text-align: center;">${v.createTime}</td> 
                                	...
                                	<td style="text-align: center;"><a href="javascript:;" class="layui-btn layui-btn-normal layui-btn-small" title="题目列表" onclick="problemList(${v.id})">题目列表</a></td>
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['90%','90%'],
      title: '修改',
      content: sysUrl+'evaluate/toModify?id='+id 
    });
...
function problemList(id){
    ...
    layer.open({
      ...
      area: ['95%','95%'],
      title: '题目列表',
      content: sysUrl+'evaluate/problemList?eid='+id 
    });

						...
						<div class="layui-form" action="">
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" id="title" 
											value="" placeholder="请输入酒店名称"  lay-verify="" autocomplete="off"
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" name="intro" id="intro" 
											value="" placeholder="请输入酒店简介"  lay-verify="" autocomplete="off"
											class="layui-input" style="width: 300px">
									</div>
								</div>
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										value="" placeholder="请输入酒店起价" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
...
**/
                					...
                					jq.post('businessmenadmin/grogshop/addGrogshop',json,function(data){

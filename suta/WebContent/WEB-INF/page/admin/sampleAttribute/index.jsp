...
<div class="layui-tab layui-tab-brief main-tab-container">
	<ul class="layui-tab-title main-tab-title">
		<li class="layui-this" style="border-bottom: 0px;top:0px;">示例属性列表</li>
		<div class="main-tab-item" style="left: 10px;top:0px;">示例属性管理</div>
	</ul>
...
<script type="text/javascript">
	...
	function pageJump(pageNumber){
		search = $("#search").val();
		window.location.href = 'getSampleAttributeList?offset='+pageNumber+'&limit='+page_size+'&search='+search;
	}
...
function toAdd(){
    ...
    layer.open({
      ...
      area: ['60%','60%'],
      title: '添加',
      content: sysUrl+'sampleAttribute/toAdd'
    });
...
function toMod(id){
    ...
    layer.open({
      ...
      area: ['60%','60%'],
      title: '修改',
      content: sysUrl+'sampleAttribute/toModify?id='+id 
    });

...
public class StrManager {
	...
	public String cutOutStringIndex(String name) {
		if(name.length() > 11){
			name = name.substring(0,11)+"...";
		}
		return name;
	}
	public String cutOutStringList(String name) {
		int num = 13;
		if(name.length() > num){
	...
	public String getNowTime() {
		...
		String nowTimeString = formatObj.format(dateObj);
	 ...
	 * @throws
	 */
	public String notEmpty(BigDecimal bigDecimal) {
	 ...
	 * @throws
	 */
	public String notEmpty(Integer int1) {
		// TODO Auto-generated method stub

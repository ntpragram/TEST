						...
						<div class="layui-form" action="">
								<div class="layui-form-item" style="margin-top: 30px">
									...
									<div class="layui-input-block">
										<input type="text" name="title" id="title" 
											value="" placeholder="请输入名称"  lay-verify="" autocomplete="off"
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										value="" placeholder="请输入价格" required  lay-verify="" autocomplete="off"
										class="layui-input" style="width: 300px" >
						...
						<script type="text/javascript">	
							layui.use(['element', 'laypage', 'layer', 'form','upload','layedit'], function() {;  
								...
								form.on('submit(form)', function(data) {
                					...
                					jq.post('businessmenadmin/menu/addMenu',json,function(data){

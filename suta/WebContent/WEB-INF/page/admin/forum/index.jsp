       ...
       <!--  <div class="layui-form-item">
        ...
        <!-- 每页数据量 -->
			...
			<form class="layui-form">             
                <input type="hidden" id="modelName"  value="forum" >
					...
					<tbody class="table-list-box">
						<c:forEach items="${resultData.dataList}" var="v" varStatus="i">
							<tr>
                                ...
                                <td style="text-align: center;">${v.answerNum}</td>
                                <td style="text-align: center;">${v.focusNum}</td> 
                                 <td style="text-align: center;">${v.lookNum}</td> 
								...
								<a href="javascript:;" class="layui-btn layui-btn-small" title="回复" onclick="toMod(${v.id})"><i class="layui-icon">回复</i></a>
								<a href="javascript:;" class="layui-btn layui-btn-small layui-btn-danger del_btn" feedback-id="${v.id}" feedback-name="${v.content}" title="删除" >
...
function answerList(fid){
    var layer = layui.layer;
     layer.open({
      ...
      area: ['90%','90%'],
      title: '添加',
      content: sysUrl+'forum/getAnswerForumList?fid='+fid
    });
    ...
    function toMod(id){
        ...
        layer.open({
          ...
          area: ['70%','70%'],
          title: '回复',
          content: sysUrl+'forum/reply?id='+id 
        });
